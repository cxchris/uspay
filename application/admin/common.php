...
if (!function_exists('build_toolbar')) {
    ...
    function build_toolbar($btns = null, $attr = [])
    {
        ...
        $btns = $btns ? $btns : ['refresh', 'add', 'edit', 'del', 'import','check'];
        ...
        $btnAttr = [
            ...
            'check'  => ['javascript:;', 'btn btn-info btn-check', 'fa fa-check', '结算', '结算'],
            'issued'  => ['javascript:;', 'btn btn-info btn-issued', 'fa fa-issued', '申请下发', '申请下发'],
            'transfer'  => ['javascript:;', 'btn btn-info btn-transfer', 'fa fa-transfer', '将金额转移至代付', '将金额转移至代付'],
        ];
