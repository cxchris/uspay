...
class Random
{
     ...
     * @return string
     */
    public static function toupper($len = 6)
    {
        return self::build('strtoupper', $len);
    }
     ...
     * @return string
     */
    public static function tolower($len = 6)
    {
        return self::build('strtolower', $len);
    }
    ...
    {
        $num = self::toupper(1).self::tolower(1).rand(1444,9554).self::numeric(6);
        return $num;
    }
    ...
    {
        $num = self::alpha(2).self::numeric(4).time();
        return $num;
    }
     ...
     * @return string
     */
    public static function getEshopSn()
    {
        $num = 'YDHOSH'.rand(320417,601214).rand(1852,9589).self::numeric(12);
        return $num;
    }

    public static function getsfstr(){
        $num = self::toupper(4).self::numeric(6);
        return $num;
    }
